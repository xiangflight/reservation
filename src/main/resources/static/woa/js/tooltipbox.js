	...
	var tooltipbox = {
        ...
        show: function(msg, position, duration, keep) {
           ...
           if(position!='bottom' && position!='middle' && position!='top'){
            ...
            m.innerHTML = msg;
            var css = "width:60%; font-size:14px;min-width:150px; background:#000; opacity:0.65; min-height:35px; overflow:hidden; color:#fff; line-height:35px; text-align:center; border-radius:5px; position:fixed; left:20%; z-index:999999;";
            if(position=='top'){
                css+="top:10%; ";
